...
namespace SCPE
{
    ...
    public sealed class Sketch : PostProcessEffectSettings
    {
        ...
        private void Reset()
        {
            ...
            if (strokeTex.value == null)
            {
                strokeTex.overrideState = true;
                strokeTex.value = UnityEditor.AssetDatabase.LoadAssetAtPath<Texture2D>(UnityEditor.AssetDatabase.GUIDToAssetPath("8bd158bf28fbf3d4cb9151f3c3ae5516"));
            }
            #endif
        }
