...
namespace SCPE
{
    ...
    public sealed class Dithering : PostProcessEffectSettings
    {
        ...
        private void Reset()
        {
            ...
            if (lut.value == null)
            {
                lut.overrideState = true;
                lut.value = UnityEditor.AssetDatabase.LoadAssetAtPath<Texture2D>(UnityEditor.AssetDatabase.GUIDToAssetPath("7a95f13299f9b0948aff699c1881bfc6"));
            }
            #endif
        }
